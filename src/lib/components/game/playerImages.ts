...
// Alcoholic drinks
import Kalja from "$lib/assets/players/PelaajaKalja.png";
...
import Redbull from "$lib/assets/players/PelaajaRedbull.png";
import Oshee from "$lib/assets/players/PelaajaOshee.png";
